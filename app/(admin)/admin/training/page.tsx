...
import { Plus, Play, BookOpen, Clock, Users, Edit3, Trash2, ChevronRight, X, Check, Loader2, Video, ArrowLeft, Save, Lock, Award } from "lucide-react";
                                            ...
                                            <div className="flex-1 p-6 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-4 py-2.5 rounded-xl text-xs font-black uppercase tracking-wider transition-all flex items-center gap-2 bg-amber-50 text-amber-700 hover:bg-amber-100 border border-amber-200 shadow-sm"
