...
export const translations = {
    en: {
        ...
        performanceProfile: {
            ...
            generationNote: "THIS DOCUMENT IS GENERATED BY AI BASED ON MULTI-STAGE SIMULATION DATA AND VERIFIED TRAINING PERFORMANCE.",
            ...
            emptyStateDesc: "Click the button above to analyze your data and produce your executive accreditation document.",
            verificationActive: "Verification Active",
            ref: "Ref",
        },
        assetLocked: {
            mandateRequired: "Strategic Mandate Required",
            premiumOnlyDesc: "This Official Asset is reserved for Professional, Executive, and Elite members. Your current trial plan does not allow for official document generation.",
            ...
            generationNote: "Official Assets are generated based on your entire platform performance.",
            portfolioNote: "* Once locked, your Executive Portfolio is built using AI analysis of your Audit results and Simulation scores.",
        },
        roleSuggestions: {
        ...
        roadmap: {
            ...
            subtitle: "Architecture of your professional evolution, engineered from your diagnostic DNA.",
            ...
            supportMessage: "We put our elite experts at your disposal to help you implement the action plan and develop your career path based on your own diagnosis. Our consultations are individual and customized to ensure maximum success."
        },
        mentor: {
            badge: "Career Academy",
            title: "Smart AI Mentor",
            subtitle: "Your personal strategic advisor. We analyze your results to create a tailored learning path that closes your gaps and accelerates your career progress.",
            startPath: "Launch My Path",
            regeneratePath: "Regenerate Path",
            emptyTitle: "Your Personalized Learning Path",
            emptyDesc: "Ready to accelerate? Click the button above to transform your diagnostic insights into a custom mentorship academy with modules, drills, and simulations.",
        ...
        academy: {
            ...
            subtitle: "Structured high-performance consulting frameworks and management models generated specifically to bridge your diagnostic gaps.",
        ...
        roleDiscovery: {
            ...
            subtitle: "Let's explore your career goals and find the perfect roles for you.",
            progress: "Progress",
        ...
        interview: {
            ...
            subtitle: "Direct validation of competencies through a high-level strategic dialogue.",
            progress: "Progress",
            ...
            languageSubtitle: "Select the language you're most comfortable with for the verification.",
            reviewChat: "Review Chat",
            urgentAuditCompleted: "Assessment Completed",
            detectedGaps: "We have detected strategic gaps in your profile. Here is the initial analysis.",
...
By signing below, you authorize the commencement of the strategic advisory mandate.
        ...
        expert: {
            ...
            errorResponse: "I apologize, but I'm currently unable to respond. Please try again later."
        },
        auth: {
        ...
        dashboard: {
            ...
            diagnosisStatus: {
                ...
                teaserDesc: "⚠️ Initial Audit Complete! Critical gaps detected. Note: This is a \"Teaser\". The real deep diagnosis (Strategic Report, Competitive Analysis) requires an upgrade.",
                readyNext: "You have effectively completed the full diagnosis. You are now ready for the next stage of your journey!",
                cvAnalysisComplete: "Your CV analysis is complete. Next step: Start the simulation!",
                successfullyCompleted: "Successfully Completed",
                completed: "Completed",
                inProgress: "In Progress",
                moduleInfo: {
                    title: "Access Logic",
                    aiDescription: "AI-powered modules (Strategic Mentor, AI Advisor) are unlocked instantly once your core diagnosis is finalized, providing 24/7 strategic support.",
                    humanDescription: "Live Expert-led modules (Simulations, Workshops) are premium sessions that require manual activation and scheduling by our executive board according to availability."
                }
            },
            reboot: {
                confirmTitle: "⚠️ Restart Diagnosis — Are you sure?",
                confirmDesc: "All current diagnosis data (CV, interview, simulation) will be permanently cleared and you will start from scratch.\n\nClick OK to continue.",
            },
            sections: {
            ...
            support: {
                ...
                subtitle: "Have a question or encountered an issue? We are here to help you in your career journey.",
            ...
            journey: {
                ...
                stages: {
                    ...
                    diagnosisDesc: "Mandatory professional DNA analysis. This stage identifies your core strengths and critical market gaps.",
                    diagnosisObj: "Map professional assets and align with global executive standards.",
                    diagnosisOutcome: "Strategic Career Intelligence (SCI) initial profile.",
                    
                    simulation: "Expert Simulations",
                    simulationDesc: "Pressure-test your leadership in a mimicked corporate environment with human experts.",
                    simulationObj: "Evaluate real-world decision-making and IQ/EQ performance under focus.",
                    simulationOutcome: "Verified readiness score and detailed performance brief.",
                    
                    training: "Executive Workshops",
                    trainingDesc: "Targeted live sessions designed specifically to bridge the technical and soft gaps found in your audit.",
                    trainingObj: "Acquire specialized capabilities and operational methodologies.",
                    trainingOutcome: "Official workshop attestations and gap-fix validation.",
                    
                    library: "Executive Resource Vault",
                    libraryDesc: "A curated bank of audit protocols, risk matrices, and strategic models used by top-tier consultants.",
                    libraryObj: "Empower daily operations with professional-grade strategic tools.",
                    libraryOutcome: "Complete autonomy in executing high-level consulting tasks.",
                    
                    expert: "Direct Boardroom Access",
                    expertDesc: "Direct consultation with specialized executive mentors to validate your long-term career moves.",
                    expertObj: "Receive high-level strategic guidance and project validation.",
                    expertOutcome: "Strategic mentorship and elite professional networking.",
                    
                    strategicReport: "Full Strategic Intelligence (SCI)",
                    strategicReportDesc: "The ultimate 18-month career roadmap powered by AI and human expert analysis.",
                    strategicReportObj: "Design a definitive path to boardroom leadership and market dominance.",
        ...
        sidebar: {
            categories: {
                ...
                strategicTools: "Strategic Intelligence",
        ...
        workshops: {
            ...
            subtitle: "Join live interactive sessions with industry experts. Recordings available after the event.",
            ...
            accreditationDesc: "Completed all session replays? Claim your workshop participation certificate. Our consultant will review and grant access.",
            ...
            teamPromoDesc: "We provide strategic training programs customized to corporate and group needs. Contact the administrator to request a quote and a tailor-made program.",
            requestEmail: "Request via Email",
            seatsLeft: "Seats Left",
            alerts: {
                pending: "Your access request is pending. Please wait for the consultant to approve.",
                denied: "Access Denied. You are not enrolled. Please confirm your seats first.",
                notStarted: "This workshop session hasn't started yet. Please wait for the admin to open access."
            },
            protocol: {
                ...
                expertReviewDesc: "After reviewing your diagnosis, an expert defines your modules, hours, and personalized training objectives.",
                microGroupTitle: "Micro-Group Filtering",
                microGroupDesc: "We match you with participants (max 5) sharing the same professional level and needs for high-quality interaction.",
                flexibleTitle: "Flexible Enrollment & Cost",
                flexibleDesc: "Choose between individual sessions or groups (2-3). Individual costs decrease as group size increases.",
                schedulingTitle: "Final Scheduling (7 Days)",
                schedulingDesc: "Once the requested group is formed, session dates are finalized within a maximum of 7 days.",
                waitingStatus: "Waiting for diagnosis completion and session customization",
        ...
        diagnosticFlow: {
            ...
            subtitle: "A 3-stage strategic audit to certify your executive readiness.",
            stages: [
                {
                    id: "01",
        ...
        cvUpload: {
            ...
            subtitle: "Our AI engine will analyze your experience, skills, and potential gaps.",
    ...
    fr: {
        ...
        results: {
            ...
            levelBasedOn: "Basé sur la profondeur technique et la conscience stratégique.",
        ...
        performanceProfile: {
            ...
            title: "Évaluation des Capacités Stratégiques",
            subtitle: "Analyse Complète & Évaluation de la Préparation Professionnelle",
            ...
            generationNote: "CE DOCUMENT EST GÉNÉRÉ PAR IA SUR LA BASE DE DONNÉES DE SIMULATION MULTI-ÉTAPES ET DE PERFORMANCES DE FORMATION VÉRIFIÉES.",
            ...
            synthesisNote: "Synthèse des données de diagnostic + formation + simulation",
            emptyStateTitle: "Profil de Performance non encore créé",
            emptyStateDesc: "Cliquez sur le bouton ci-dessus pour analyser vos données et produire votre document d'accréditation exécutif.",
            verificationActive: "Vérification Active",
            ref: "Réf.",
        },
        assetLocked: {
            mandateRequired: "Mandat Stratégique Requis",
            premiumOnlyDesc: "Cet Asset Officiel est réservé aux membres Professional, Executive et Elite. Votre mandat actuel ne permet pas la génération de documents officiels.",
            ...
            generationNote: "Les Assets Officiels sont générés sur la base de votre performance globale sur la plateforme.",
            portfolioNote: "* Une fois débloqué, votre Portfolio Exécutif est construit à l'aide de l'analyse IA de vos résultats d'audit et de vos scores de simulation.",
        },
        roleSuggestions: {
        ...
        mentor: {
            ...
            title: "Mentor IA Intelligent",
            subtitle: "Votre conseiller stratégique personnel. Nous analysons vos résultats pour créer un parcours d'apprentissage sur mesure qui comble vos lacunes et accélère votre progression.",
            startPath: "Lancer mon Parcours",
            regeneratePath: "Régénérer le Parcours",
            emptyTitle: "Votre Académie de Mentorat Personnalisée",
            emptyDesc: "Prêt à accélérer ? Cliquez sur le bouton ci-dessus pour transformer vos résultats de diagnostic en un programme d'entraînement complet : modules, exercices et simulations.",
            ...
            roadmapSubtitle: "Jalons étape par étape pour combler vos lacunes identifiées.",
            councilTitle: "Le Conseil d'Experts",
            councilSubtitle: "Insights industriels confidentiels adaptés à votre profil.",
            preparing: "Préparation de l'espace...",
        },
        roadmap: {
            badge: "Déploiement Stratégique IA",
            title: "Feuille de Route",
            subtitle: "Architecture de votre évolution professionnelle, conçue à partir de votre ADN diagnostique.",
            ...
            supportMessage: "Nous mettons nos experts d'élite à votre disposition pour vous aider à mettre en œuvre le plan d'action et à développer votre parcours professionnel en fonction de votre propre diagnostic. Nos consultations sont individuelles et personnalisées pour garantir un succès maximal."
        },
        academy: {
            badge: "Apprentissage Propulsé par l'IA",
            title: "Ressources Stratégiques",
            subtitle: "Frameworks de conseil et modèles de gestion haute performance générés spécifiquement pour répondre aux défis de votre audit.",
        ...
        roleDiscovery: {
            ...
            subtitle: "Explorons vos objectifs de carrière et trouvons les rôles parfaits pour vous.",
        ...
        interview: {
            ...
            subtitle: "Validation directe des compétences via un dialogue stratégique de haut niveau.",
            progress: "Progression",
            ...
            languageSubtitle: "Sélectionnez la langue avec laquelle vous êtes le plus à l'aise pour la vérification.",
            reviewChat: "Revoir le Chat",
            urgentAuditCompleted: "Évaluation Terminée",
            detectedGaps: "Nous avons détecté des lacunes stratégiques dans votre profil. Voici l'analyse initiale.",
...
En signant ci-dessous, vous acceptez de commencer le processus de conseil.
        ...
        expert: {
            ...
            errorResponse: "Je m'excuse, mais je suis actuellement incapable de répondre. Veuillez réessayer plus tard."
        },
        auth: {
        ...
        dashboard: {
            ...
            stats: {
                ...
                simulationScore: "Score de Simulation",
            ...
            diagnosisStatus: {
                ...
                teaserDesc: "⚠️ Audit Initial Terminé ! Lacunes critiques détectées. Note : Ceci est un \"Teaser\". Le véritable diagnostic approfondi (Rapport Stratégique, Analyse Concurrentielle) nécessite une mise à niveau.",
                readyNext: "Vous avez complété avec succès le diagnostic complet. Vous êtes maintenant prêt pour la prochaine étape de votre parcours !",
                cvAnalysisComplete: "L'analyse de votre CV est terminée. Étape suivante : Commencez la simulation !",
                successfullyCompleted: "Terminé avec Succès",
                completed: "Terminé",
                inProgress: "En Cours",
                moduleInfo: {
                    title: "Logique d'Accès",
                    aiDescription: "Les modules propulsés par l'IA (Mentor Stratégique, Conseiller IA) sont débloqués instantanément dès la finalisation de votre diagnostic, offrant un support stratégique 24/7.",
                    humanDescription: "Les modules Live avec Experts (Simulations, Workshops) sont des sessions premium nécessitant une activation manuelle et une planification par notre conseil de direction selon les disponibilités."
                }
            },
            reboot: {
                confirmTitle: "⚠️ Redémarrer le Diagnostic — Êtes-vous sûr ?",
                confirmDesc: "Toutes les données de diagnostic actuelles (CV, entretien, simulation) seront définitivement effacées et vous repartirez de zéro.\n\nCliquez sur OK pour continuer.",
            },
            sections: {
            ...
            support: {
                ...
                subtitle: "Vous avez une question ou un problème ? Nous sommes là pour vous aider.",
            ...
            journey: {
                ...
                stages: {
                    ...
                    diagnosisDesc: "Analyse obligatoire de l'ADN professionnel. Identifie vos forces et vos lacunes critiques par rapport au marché.",
                    diagnosisObj: "Cartographier les actifs professionnels et s'aligner sur les standards exécutifs mondiaux.",
                    diagnosisOutcome: "Profil initial d'Intelligence de Carrière Stratégique (SCI).",
                    
                    simulation: "Simulations d'Experts",
                    simulationDesc: "Testez votre leadership dans un environnement d'entreprise simulé avec des experts humains.",
                    simulationObj: "Évaluer la prise de décision et la performance IQ/EQ sous pression.",
                    simulationOutcome: "Score de préparation vérifié et compte-rendu de performance détaillé.",
                    
                    training: "Workshops Exécutifs",
                    trainingDesc: "Sessions ciblées en direct conçues pour combler les lacunes techniques et comportementales identifiées.",
                    trainingObj: "Acquérir des capacités spécialisées et des méthodologies opérationnelles.",
                    trainingOutcome: "Attestations officielles et validation de la correction des lacunes.",
                    
                    library: "Coffre-fort de Ressources",
                    libraryDesc: "Une banque de protocoles d'audit et de modèles stratégiques utilisés par les grands cabinets.",
                    libraryObj: "Renforcer les opérations quotidiennes avec des outils stratégiques de niveau professionnel.",
                    libraryOutcome: "Autonomie complète dans l'exécution de tâches de conseil de haut niveau.",
                    
                    expert: "Accès Direct au Boardroom",
                    expertDesc: "Consultation directe avec des mentors exécutifs spécialisés pour valider vos mouvements de carrière.",
                    expertObj: "Recevoir une guidance stratégique de haut niveau et une validation de projet.",
                    expertOutcome: "Mentorat stratégique et réseautage professionnel d'élite.",
                    
                    strategicReport: "Intelligence Stratégique Complète (SCI)",
                    strategicReportDesc: "La roadmap ultime de 18 mois pour votre carrière, propulsée par l'IA et l'expertise humaine.",
                    strategicReportObj: "Concevoir un chemin définitif vers le leadership et la dominance du marché.",
        ...
        sidebar: {
            categories: {
                ...
                strategicTools: "Intelligence Stratégique",
            ...
            items: {
                ...
                diagnosis: "Diagnostic & Audit de Carrière",
                mentor: "Conseiller IA (Mentor)",
                academy: "Base de Connaissances",
                expert: "Expert IA Consultation",
                roadmap: "Feuille de Route Stratégique",
                training: "Workshops Exécutifs (Live)",
                tools: "Simulations Réelles (Expert)",
                library: "Virothèque de Ressources (Expert)",
                strategicReport: "Intelligence Stratégique",
                jobAlignment: "Alignement Stratégique",
                attestations: "Attestation de Workshop",
                recommendation: "Lettre de Recommandation",
                certificates: "Capacités Stratégiques",
        ...
        workshops: {
            ...
            subtitle: "Rejoignez des sessions interactives en direct avec des experts du secteur. Enregistrements disponibles après l'événement.",
            ...
            noRecordings: "Aucun enregistrement disponible pour ce workshop pour le moment.",
            replayDesc: "Rediffusion de session enregistrée",
            viewReplay: "Regarder le Replay",
            accreditationTitle: "Accréditation du Workshop",
            accreditationDesc: "Vous avez terminé tous les replays ? Demandez votre attestation de participation. Notre consultant examinera et accordera l'accès.",
            ...
            teamPromoTitle: "Vous voulez un workshop personnalisé pour votre équipe ?",
            teamPromoDesc: "Nous proposons des programmes de formation stratégique adaptés aux besoins des entreprises et des groupes. Contactez l'administrateur pour demander un devis et un programme sur mesure.",
            requestEmail: "Demander par Email",
            seatsLeft: "places restantes",
            alerts: {
                pending: "Votre demande d'accès est en attente. Veuillez attendre l'approbation du consultant.",
                denied: "Accès refusé. Vous n'êtes pas inscrit. Veuillez d'abord confirmer vos places.",
                notStarted: "Cette session de workshop n'a pas encore commencé. Veuillez attendre que l'administrateur ouvre l'accès."
            },
            protocol: {
                ...
                expertReviewDesc: "Après avoir examiné votre diagnostic, un expert définit vos modules, vos heures et vos objectifs de formation personnalisés.",
                microGroupTitle: "Filtrage par Micro-Groupe",
                microGroupDesc: "Nous vous mettons en relation avec des participants (5 maximum) partageant le même niveau professionnel et les mêmes besoins pour une interaction de haute qualité.",
                flexibleTitle: "Inscription et Coût Flexibles",
                flexibleDesc: "Choisissez entre des sessions individuelles ou des groupes (2-3). Les coûts individuels diminuent à mesure que la taille du groupe augmente.",
                schedulingTitle: "Planification Finale (7 Jours)",
                schedulingDesc: "Une fois le groupe formé, les dates des sessions sont finalisées dans un délai maximum de 7 jours.",
                waitingStatus: "En attente de l'achèvement du diagnostic et de la personnalisation des sessions",
        ...
        diagnosticFlow: {
            ...
            subtitle: "Un audit stratégique en 3 étapes pour certifier votre préparation exécutive.",
            stages: [
                {
                    id: "01",
        ...
        cvUpload: {
            ...
            subtitle: "Notre moteur IA analysera votre expérience, vos compétences et vos lacunes potentielles.",
            dragDrop: "Glissez-déposez votre CV",
            fileTypes: "Supporte PDF, DOCX, TXT (Max 500Mo)",
            browse: "Parcourir les fichiers",
            analyzing: "L'IA analyse le profil...",
            extracting: "Extraction des compétences, de l'expérience et des perspectives de carrière.",
    ...
    ar: {
        ...
        performanceProfile: {
            ...
            title: "تقييم القدرات الاستراتيجية",
            ...
            generationNote: "تم إنشاء هذه الوثيقة بواسطة الذكاء الاصطناعي بناءً على بيانات محاكاة متعددة المراحل وأداء تدريبي مُحقق.",
            ...
            emptyStateDesc: "اضغط على الزر أعلاه لتحليل بياناتك وإنتاج وثيقة الاعتماد التنفيذية الخاصة بك.",
            verificationActive: "التحقق نشط",
            ref: "مرجع",
        },
        assetLocked: {
            mandateRequired: "مطلوب تفويض استراتيجي",
            premiumOnlyDesc: "هذا الأصل الرسمي محجوز لأعضاء الفئات الاحترافية والتنفيذية والنخبة. خطتك الحالية لا تسمح بإصدار وثائق رسمية.",
            ...
            executeNow: "نفذ الآن",
            generationNote: "يتم إنشاء الأصول الرسمية بناءً على أدائك الكامل في المنصة.",
            portfolioNote: "* بمجرد فتحه، يتم بناء ملفك التنفيذي باستخدام تحليل الذكاء الاصطناعي لنتائج التدقيق ودرجات المحاكاة.",
        },
        roleSuggestions: {
        ...
        roadmap: {
            ...
            supportMessage: "نحن نضع نخبة خبرائنا تحت تصرفك لمساعدتك في تنفيذ خطة العمل وتطوير مسارك المهني بناءً على تشخيصك الخاص. استشاراتنا فردية ومخصصة لضمان أقصى درجات النجاح."
        },
        mentor: {
            badge: "أكاديمية المهنية",
            title: "الموجه الذكي (IA Mentor)",
            subtitle: "مستشارك الاستراتيجي الشخصي. نقوم بتحليل نتائجك لإنشاء مسار تعليمي مخصص يسد ثغراتك ويسرع تقدمك المهني بشكل فعال.",
            startPath: "ابدأ مساري التعليمي",
            regeneratePath: "إعادة إنشاء المسار",
            emptyTitle: "أكاديميتك التوجيهية المخصصة",
            emptyDesc: "هل أنت مستعد للتطور؟ انقر على الزر أعلاه لتحويل نتائج تشخيصك إلى برنامج تدريبي ذكي يشمل وحدات تعليمية، تمارين عملية، ومحاكاة للواقع.",
            ...
            roadmapSubtitle: "خطوات مرحلية محددة لسد الفجوات المهنية التي تم تحديدها.",
            councilTitle: "مجلس الخبراء استراتيجي",
            councilSubtitle: "رؤى وتوصيات حصرية من الصناعة مصممة خصيصاً لملفك المهني.",
            preparing: "جاري تحضير المساحة...",
        },
        academy: {
            badge: "تعلم مدعوم بالذكاء الاصطناعي",
            title: "الموارد الاستراتيجية",
            subtitle: "أطر عمل استشارية ونماذج إدارية عالية الأداء تم إنشاؤها خصيصاً لسد الفجوات المهنية المحددة في تشخيصك.",
        ...
        interview: {
            ...
            detectedGaps: "لقد اكتشفنا ثغرات استراتيجية في ملفك الشخصي. إليك التحليل الأولي.",
        ...
        simulation: {
            ...
            noMissionProtocol: {
                ...
                intro: "يخضع ملفك المهني حالياً لمرحلة 'هندسة المهمة' من قبل خبراء المجمع. نقوم بتصميم سيناريو 'وظيفة تنفيذية' مخصص لك بالكامل، حيث ستواجه مهاماً وتحديات استراتيجية واقعية تتبع تطورك المهني.",
                features: [
                    {
...
بالتوقيع أدناه، أنت تفوض البدء الفوري في تنفيذ مهام التفويض الاستراتيجي.
        ...
        expert: {
            ...
            errorResponse: "أعتذر، لكني غير قادر على الرد حالياً. يرجى المحاولة مرة أخرى لاحقاً."
        },
        auth: {
        ...
        dashboard: {
            ...
            diagnosisStatus: {
                ...
                teaserDesc: "⚠️ التشخيص الأولي مكتمل بنجاح! لقد كشفنا عن ثغرات حرجة. ملاحظة: هذا مجرد \"تشويق\"، التشخيص الحقيقي العميق (التقرير الاستراتيجي، تحليل التنافسية) يتطلب الترقية.",
                readyNext: "لقد أكملت التشخيص بالكامل. أنت الآن مستعد للمرحلة التالية من رحلتك!",
                cvAnalysisComplete: "تم تحليل سيرتك الذاتية بنجاح. الخطوة التالية: ابدأ المحاكاة!",
                successfullyCompleted: "مكتمل بنجاح",
                completed: "مكتمل",
                inProgress: "قيد التنفيذ",
                moduleInfo: {
                    title: "نظام الوصول",
                    aiDescription: "وحدات الذكاء الاصطناعي (المرشد الاستراتيجي، المستشار الذكي) يتم تفعيلها فورياً بمجرد اكتمال التشخيص الأساسي، مما يوفر لك دعماً استراتيجياً على مدار الساعة.",
                    humanDescription: "وحدات الجلسات المباشرة مع الخبراء (المحاكاة، الورش العملية) هي جلسات مميزة تتطلب تفعيلاً يدوياً وجدولة من قبل فريقنا الاستشاري وفقاً للمواعيد المتاحة."
                }
            },
            reboot: {
                confirmTitle: "⚠️ إعادة التشخيص — هل أنت متأكد؟",
                confirmDesc: "سيتم مسح جميع بيانات التشخيص الحالية (السيرة الذاتية، المقابلة، المحاكاة) وستبدأ من الصفر.\n\nاضغط \"موافق\" للمتابعة.",
            },
            sections: {
            ...
            support: {
                ...
                subtitle: "هل لديك استفسار أو واجهت مشكلة؟ نحن هنا لمساعدتك في رحلتك المهنية.",
            ...
            journey: {
                ...
                stages: {
                    ...
                    diagnosisDesc: "تحليل إلزامي للحمض النووي المهني. تحدد هذه المرحلة نقاط قوتك والفجوات الحرجة في السوق.",
                    diagnosisObj: "رسم خرائط الأصول المهنية والتوافق مع المعايير التنفيذية العالمية.",
                    diagnosisOutcome: "الملف الأولي لذكاء المسار الوظيفي الاستراتيجي (SCI).",

                    simulation: "محاكاة الخبراء",
                    simulationDesc: "اختبار قيادتك تحت الضغط في بيئة مؤسسية محاكية مع خبراء بشريين.",
                    simulationObj: "تقييم اتخاذ القرار والأداء الفكري والعاطفي تحت التركيز.",
                    simulationOutcome: "درجة جاهزية مؤكدة وإيجاز مفصل عن الأداء.",

                    training: "ورش العمل التنفيذية",
                    trainingDesc: "جلسات مباشرة مستهدفة مصممة خصيصاً لسد الفجوات التقنية والقيادية الموجودة في تدقيقك.",
                    trainingObj: "اكتساب قدرات متخصصة ومنهجيات عملياتية حديثة.",
                    trainingOutcome: "شهادات ورش عمل رسمية والتحقق من سد الفجوات.",

                    library: "خزنة الموارد الاستراتيجية",
                    libraryDesc: "بنك من بروتوكولات التدقيق ومصفوفات المخاطر المستخدمة من قبل كبرى شركات الاستشارات.",
                    libraryObj: "تمكين العمليات اليومية بأدوات استراتيجية ذات مستوى احترافي.",
                    libraryOutcome: "استقلالية كاملة في تنفيذ مهام الاستشارات عالية المستوى.",

                    expert: "الوصول المباشر لمكاتب القيادة",
                    expertDesc: "استشارة مباشرة مع موجهين تنفيذيين متخصصين للتحقق من تحركاتك المهنية طويلة الأمد.",
                    expertObj: "تلقي توجيه استراتيجي رفيع المستوى والتحقق من المشاريع.",
                    expertOutcome: "توجيه استراتيجي وشبكات مهنية نخبوية.",

                    strategicReport: "ذكاء المسار الوظيفي الشامل (SCI)",
                    strategicReportDesc: "خارطة الطريق النهائية لمدة 18 شهراً المدعومة بالذكاء الاصطناعي وتحليل الخبراء.",
                    strategicReportObj: "تصميم مسار حاسم نحو قيادة مجالس الإدارة والسيطرة على السوق.",
            ...
            upsell: {
                ...
                item3: "تقرير الذكاء المهني الشامل (SCI)"
            },
            notStarted: {
        ...
        sidebar: {
            categories: {
                ...
                strategicTools: "الذكاء الاستراتيجي",
            ...
            items: {
                ...
                mentor: "مستشار الذكاء الاصطناعي (المرشد)",
                academy: "قاعدة المعرفة",
                expert: "استشارة خبير ذكاء اصطناعي",
                roadmap: "خارطة الطريق الاستراتيجية",
                training: "ورش عمل تنفيذية (مباشر)",
                tools: "محاكاة واقعية (بإشراف خبير)",
                library: "مكتبة الموارد الاستراتيجية (خبير)",
                strategicReport: "الذكاء الاستراتيجي",
                jobAlignment: "التوافق الاستراتيجي",
                attestations: "شهادة ورشة العمل",
                recommendation: "خطاب التوصية",
                certificates: "القدرات الاستراتيجية",
        ...
        workshops: {
            ...
            subtitle: "انضم إلى جلسات تفاعلية مباشرة مع خبراء الصناعة. التسجيلات متاحة بعد الحدث.",
            ...
            accreditationDesc: "هل أكملت جميع إعادات الجلسات؟ اطلب شهادة المشاركة في ورشة العمل. سيقوم مستشارنا بالمراجعة ومنح الوصول.",
            ...
            teamPromoDesc: "نحن نوفر برامج تدريبية استراتيجية مخصصة حسب احتياجات الشركات والمجموعات. تواصل مع المسؤول المباشر لطلب عرض سعر وبرنامج مخصص.",
            ...
            alerts: {
                ...
                notStarted: "جلسة ورشة العمل هذه لم تبدأ بعد. يرجى انتظار المسؤول لفتح باب الدخول."
            },
            protocol: {
                ...
                expertReviewDesc: "بعد قراءة التشخيص، يحدد الخبير الموديولات، الساعات، والأهداف التدريبية المخصصة لك بدقة.",
                microGroupTitle: "فلترة المجموعات المصغرة",
                microGroupDesc: "نجمعك مع مشاركين (بحد أقصى 5) لديهم نفس المستوى والاحتياجات لضمان جودة التفاعل.",
                flexibleTitle: "تحكم مرن بالعدد والتكلفة",
                flexibleDesc: "يمكنك الاختيار بين جلسة فردية أو مجموعة (2-3 أشخاص). كلما زاد عدد المجموعة، قلت التكلفة الفردية.",
                schedulingTitle: "تأكيد الموعد النهائي (7 أيام)",
                schedulingDesc: "بمجرد اكتمال المجموعة المطلوبة، يتم تثبيت مواعيد الجلسات بحد أقصى 7 أيام من تاريخ التأكيد.",
        ...
        cvUpload: {
            ...
            subtitle: "سيقوم محرك الذكاء الاصطناعي بتحليل خبراتك ومهاراتك والفجوات المحتملة.",
